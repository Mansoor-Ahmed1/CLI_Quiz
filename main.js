...
let score = 0;
let right_choice = "Congratulations, You got it right";
let wrong_choice = "Unfortunately, It is not the correct answer.";
...
let instructions = "You will earn a point for every correct answer, While no point will be deducted for wrong answer. You can get a maximum of 5 points by answering all 5 question correctly.";
